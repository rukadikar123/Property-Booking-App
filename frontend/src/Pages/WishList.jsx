  ...
  return (
    <>
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
       {
        wishlist.length===0 ? (
          <p className="text-center text-xl font-medium text-gray-500">You haven’t added any properties to your wishlist yet. </p>
        ) : (
           <>
          ...
          {wishlist &&
            wishlist?.map((property) => (
              <div
                ...
                onClick={() => navigate(`/listing/${property?.property?._id}`)}
              ...
              >
                ...
                <div className="p-4 flex flex-col gap-2">
                  ...
                  <p className="text-sm text-gray-500">{property?.property?.location}</p>
